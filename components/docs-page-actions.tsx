...
function ClaudeLogo() {
  return (
    <svg fill="currentColor" role="img" viewBox="0 0 24 24" className="size-4" aria-hidden="true">
      ...
      <PopoverContent className="flex flex-col">
        {items.map((item) => (
          <a
            ...
            target="_blank"
            className="inline-flex items-center gap-2 rounded-lg p-2 text-sm hover:bg-fd-accent hover:text-fd-accent-foreground [&_svg]:shrink-0"
          >
            {item.icon}
            {item.title}
