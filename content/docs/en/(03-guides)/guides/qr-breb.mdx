...
Spotlight explicitly documents the create step with `"Bre-B": true` inside `payment_method_enabled`.
...
|------------|---------------------|---------------|
| `"Bre-B": true` in `payment_method_enabled` | Spotlight | Bre-B should be offered on the cobru |
