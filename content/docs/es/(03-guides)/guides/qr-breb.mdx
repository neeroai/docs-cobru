...
Spotlight documenta explícitamente el paso de creación con `"Bre-B": true` dentro de `payment_method_enabled`.
...
|-----------|---------------|---------------|
| `"Bre-B": true` en `payment_method_enabled` | Spotlight | el cobru debe ofrecer Bre-B |
